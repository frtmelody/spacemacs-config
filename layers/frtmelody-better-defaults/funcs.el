...
(defun frtmelody/smart-open-line ()
...
(defun frtmelody/rename-file-and-buffer ()
...
(defun frtmelody/yank-to-end-of-line ()
  "Yank to end of line."
  (interactive)
...
(defun frtmelody/dired-do-command (command)
...
(defun frtmelody/dired-up-directory()
